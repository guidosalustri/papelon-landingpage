...
<div class="games-container">
  ...
  <div style="flex: 1;">
    ...
    <p>Los <kbd class="kbd-pink">juegos de mesa</kbd> son geniales para divertirse, pero también pueden crear un <kbd class="kbd-pink">espacio seguro</kbd> que favorece la integración, la regulación emocional y las habilidades cognitivas. ¡Eso deja muchísimo espacio para <kbd class="kbd-pink">explorar</kbd> y <kbd class="kbd-pink">crear</kbd>!</p>
  </div>
</div>
